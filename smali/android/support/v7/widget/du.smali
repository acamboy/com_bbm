...
.method private constructor <init>(Landroid/support/v7/widget/Toolbar;)V
    ...
    .prologue
    .line 1879
    iput-object p1, p0, Landroid/support/v7/widget/du;->c:Landroid/support/v7/widget/Toolbar;
...
.method synthetic constructor <init>(Landroid/support/v7/widget/Toolbar;B)V
    ...
    .prologue
    .line 1879
    invoke-direct {p0, p1}, Landroid/support/v7/widget/du;-><init>(Landroid/support/v7/widget/Toolbar;)V
...
.method public final a(Landroid/content/Context;Landroid/support/v7/internal/view/menu/i;)V
    ...
    .prologue
    .line 1886
    iget-object v0, p0, Landroid/support/v7/widget/du;->a:Landroid/support/v7/internal/view/menu/i;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/du;->b:Landroid/support/v7/internal/view/menu/m;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/du;->b:Landroid/support/v7/internal/view/menu/m;

    invoke-virtual {v0, v1}, Landroid/support/v7/internal/view/menu/i;->b(Landroid/support/v7/internal/view/menu/m;)Z

    .line 1889
    :cond_0
    iput-object p2, p0, Landroid/support/v7/widget/du;->a:Landroid/support/v7/internal/view/menu/i;
...
.method public final b(Z)V
    ...
    .line 1903
    iget-object v1, p0, Landroid/support/v7/widget/du;->a:Landroid/support/v7/internal/view/menu/i;
    ...
    .line 1906
    iget-object v3, p0, Landroid/support/v7/widget/du;->a:Landroid/support/v7/internal/view/menu/i;
    ...
    .line 1907
    iget-object v4, p0, Landroid/support/v7/widget/du;->b:Landroid/support/v7/internal/view/menu/m;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/du;->c(Landroid/support/v7/internal/view/menu/m;)Z
...
.method public final b(Landroid/support/v7/internal/view/menu/m;)Z
    ...
    .line 1941
    iget-object v0, p0, Landroid/support/v7/widget/du;->c:Landroid/support/v7/widget/Toolbar;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/du;->c:Landroid/support/v7/widget/Toolbar;
    ...
    .line 1946
    iput-object p1, p0, Landroid/support/v7/widget/du;->b:Landroid/support/v7/internal/view/menu/m;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/du;->c:Landroid/support/v7/widget/Toolbar;
    ...
    .line 1957
    invoke-virtual {p1, v3}, Landroid/support/v7/internal/view/menu/m;->d(Z)V
...
.method public final c(Landroid/support/v7/internal/view/menu/m;)Z
    ...
    iput-object v3, v0, Landroid/support/v7/widget/Toolbar;->b:Landroid/view/View;
    ...
    .line 1979
    iput-object v3, p0, Landroid/support/v7/widget/du;->b:Landroid/support/v7/internal/view/menu/m;
    ...
    .line 1981
    invoke-virtual {p1, v2}, Landroid/support/v7/internal/view/menu/m;->d(Z)V
