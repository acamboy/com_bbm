...
.field final c:Landroid/support/v7/widget/o;

.field d:Ljava/lang/Runnable;

.field final e:Z

.field final f:Landroid/support/v7/widget/bg;
...
.method constructor <init>(Landroid/support/v7/widget/o;)V
    ...
    invoke-direct {p0, p1, v0}, Landroid/support/v7/widget/n;-><init>(Landroid/support/v7/widget/o;B)V

    .line 72
    return-void
.end method

.method private constructor <init>(Landroid/support/v7/widget/o;B)V
    .locals 1
    ...
    iput-object v0, p0, Landroid/support/v7/widget/n;->g:Landroid/support/v4/e/o;
    ...
    .line 75
    iput-object p1, p0, Landroid/support/v7/widget/n;->c:Landroid/support/v7/widget/o;
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/bg;-><init>(Landroid/support/v7/widget/bh;)V

    iput-object v0, p0, Landroid/support/v7/widget/n;->f:Landroid/support/v7/widget/bg;
...
.method private a(Landroid/support/v7/widget/p;I)V
    ...
    .prologue
    .line 308
    iget-object v0, p0, Landroid/support/v7/widget/n;->c:Landroid/support/v7/widget/o;
...
.method private b(Landroid/support/v7/widget/p;)V
    ...
    invoke-direct {p0, v0, v3}, Landroid/support/v7/widget/n;->b(II)I
    ...
    invoke-direct {p0, v7, v8}, Landroid/support/v7/widget/n;->b(II)I
...
.method public final a(III)Landroid/support/v7/widget/p;
    ...
    .prologue
    .line 650
    iget-object v0, p0, Landroid/support/v7/widget/n;->g:Landroid/support/v4/e/o;
...
.method final b()V
    ...
    .prologue
    .line 91
    iget-object v6, p0, Landroid/support/v7/widget/n;->f:Landroid/support/v7/widget/bg;

    iget-object v7, p0, Landroid/support/v7/widget/n;->a:Ljava/util/ArrayList;
    ...
    iget v4, v1, Landroid/support/v7/widget/p;->c:I
    ...
    iget v9, v0, Landroid/support/v7/widget/p;->c:I

    if-ge v2, v9, :cond_a

    const/4 v2, 0x0

    iget v9, v1, Landroid/support/v7/widget/p;->b:I

    iget v10, v0, Landroid/support/v7/widget/p;->b:I

    if-ne v9, v10, :cond_7

    iget v9, v1, Landroid/support/v7/widget/p;->c:I

    iget v10, v0, Landroid/support/v7/widget/p;->c:I
    ...
    iget v10, v1, Landroid/support/v7/widget/p;->b:I
    ...
    iput v9, v1, Landroid/support/v7/widget/p;->b:I
    ...
    iget-object v1, v6, Landroid/support/v7/widget/bg;->a:Landroid/support/v7/widget/bh;

    invoke-interface {v1, v0}, Landroid/support/v7/widget/bh;->a(Landroid/support/v7/widget/p;)V
    ...
    iget v11, v0, Landroid/support/v7/widget/p;->c:I
    ...
    iget v2, v1, Landroid/support/v7/widget/p;->c:I

    add-int/lit8 v2, v2, -0x1

    iput v2, v1, Landroid/support/v7/widget/p;->c:I
    ...
    iget-object v0, v6, Landroid/support/v7/widget/bg;->a:Landroid/support/v7/widget/bh;

    invoke-interface {v0, v1}, Landroid/support/v7/widget/bh;->a(Landroid/support/v7/widget/p;)V
    ...
    iget-object v9, v6, Landroid/support/v7/widget/bg;->a:Landroid/support/v7/widget/bh;
    ...
    invoke-interface {v9, v10, v11, v4}, Landroid/support/v7/widget/bh;->a(III)Landroid/support/v7/widget/p;
    ...
    iput v9, v1, Landroid/support/v7/widget/p;->c:I
    ...
    iget v3, v4, Landroid/support/v7/widget/p;->c:I
    ...
    iget v10, v1, Landroid/support/v7/widget/p;->c:I
    ...
    iget-object v2, v6, Landroid/support/v7/widget/bg;->a:Landroid/support/v7/widget/bh;
    ...
    invoke-interface {v2, v4, v9, v10}, Landroid/support/v7/widget/bh;->a(III)Landroid/support/v7/widget/p;
    ...
    iget-object v3, v6, Landroid/support/v7/widget/bg;->a:Landroid/support/v7/widget/bh;
    ...
    invoke-interface {v3, v9, v10, v4}, Landroid/support/v7/widget/bh;->a(III)Landroid/support/v7/widget/p;
    ...
    iput v4, v1, Landroid/support/v7/widget/p;->c:I
    ...
    iget-object v9, p0, Landroid/support/v7/widget/n;->c:Landroid/support/v7/widget/o;

    invoke-interface {v9, v2}, Landroid/support/v7/widget/o;->a(I)Landroid/support/v7/widget/cl;

    move-result-object v9

    if-nez v9, :cond_1f

    invoke-direct {p0, v2}, Landroid/support/v7/widget/n;->b(I)Z
    ...
    invoke-virtual {p0, v1, v8, v6}, Landroid/support/v7/widget/n;->a(III)Landroid/support/v7/widget/p;
    ...
    invoke-virtual {p0, v0, v8, v6}, Landroid/support/v7/widget/n;->a(III)Landroid/support/v7/widget/p;
    ...
    iget-object v8, p0, Landroid/support/v7/widget/n;->c:Landroid/support/v7/widget/o;

    invoke-interface {v8, v3}, Landroid/support/v7/widget/o;->a(I)Landroid/support/v7/widget/cl;

    move-result-object v8

    if-nez v8, :cond_27

    invoke-direct {p0, v3}, Landroid/support/v7/widget/n;->b(I)Z
    ...
    invoke-virtual {p0, v4, v2, v1}, Landroid/support/v7/widget/n;->a(III)Landroid/support/v7/widget/p;
    ...
    invoke-virtual {p0, v0, v2, v1}, Landroid/support/v7/widget/n;->a(III)Landroid/support/v7/widget/p;
...
.method final c()V
    ...
    .line 119
    iget-object v3, p0, Landroid/support/v7/widget/n;->c:Landroid/support/v7/widget/o;
