...
.method public final run()V
    ...
    invoke-virtual {v1, v3}, Landroid/support/v4/view/ct;->c(F)Landroid/support/v4/view/ct;

    move-result-object v1

    iget-object v2, p0, Landroid/support/v7/internal/widget/j;->a:Landroid/support/v7/internal/widget/ActionBarOverlayLayout;

    invoke-static {v2}, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->c(Landroid/support/v7/internal/widget/ActionBarOverlayLayout;)Landroid/support/v4/view/di;

    move-result-object v2

    invoke-virtual {v1, v2}, Landroid/support/v4/view/ct;->a(Landroid/support/v4/view/di;)Landroid/support/v4/view/ct;

    move-result-object v1

    invoke-static {v0, v1}, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->a(Landroid/support/v7/internal/widget/ActionBarOverlayLayout;Landroid/support/v4/view/ct;)Landroid/support/v4/view/ct;
    ...
    invoke-static {v2}, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->f(Landroid/support/v7/internal/widget/ActionBarOverlayLayout;)Landroid/support/v4/view/di;
    ...
    invoke-static {v0, v1}, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->b(Landroid/support/v7/internal/widget/ActionBarOverlayLayout;Landroid/support/v4/view/ct;)Landroid/support/v4/view/ct;
