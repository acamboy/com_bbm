...
.field private d:Landroid/support/v7/internal/widget/ac;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/support/v7/internal/widget/AdapterViewCompat",
            "<TT;>.android/support/v7/internal/widget/ac;"
        }
    .end annotation
.end field
...
.field s:Landroid/support/v7/internal/widget/ab;

.field t:Landroid/support/v7/internal/widget/z;

.field u:Landroid/support/v7/internal/widget/aa;
...
.method constructor <init>(Landroid/content/Context;I)V
    ...
    .line 69
    iput v1, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->j:I

    .line 86
    iput-wide v2, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->m:J

    .line 96
    iput-boolean v1, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->o:Z

    .line 128
    iput-boolean v1, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->r:Z

    .line 154
    iput v4, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->w:I

    .line 160
    iput-wide v2, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->x:J

    .line 165
    iput v4, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->y:I

    .line 171
    iput-wide v2, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->z:J

    .line 203
    iput v4, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->C:I

    .line 208
    iput-wide v2, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->D:J
...
.method private a()V
    ...
    .prologue
    .line 893
    iget-object v0, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->s:Landroid/support/v7/internal/widget/ab;
...
.method private a(Z)V
    ...
    .line 740
    iget-object v0, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->a:Landroid/view/View;
...
.method public final a(Landroid/view/View;)Z
    ...
    .line 305
    iget-object v2, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->t:Landroid/support/v7/internal/widget/z;
...
.method final b()V
    ...
    iget-boolean v0, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->c:Z
    ...
    iget-boolean v0, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->b:Z
...
.method final c()V
    ...
    iget v9, v0, Landroid/support/v7/internal/widget/AdapterViewCompat;->A:I
    ...
    iget-boolean v2, v0, Landroid/support/v7/internal/widget/AdapterViewCompat;->o:Z
    ...
    iput-boolean v2, v0, Landroid/support/v7/internal/widget/AdapterViewCompat;->o:Z

    .line 937
    move-object/from16 v0, p0

    iget v10, v0, Landroid/support/v7/internal/widget/AdapterViewCompat;->A:I

    if-eqz v10, :cond_d

    move-object/from16 v0, p0

    iget-wide v12, v0, Landroid/support/v7/internal/widget/AdapterViewCompat;->m:J

    move-object/from16 v0, p0

    iget v2, v0, Landroid/support/v7/internal/widget/AdapterViewCompat;->l:I
    ...
    iput-wide v2, v0, Landroid/support/v7/internal/widget/AdapterViewCompat;->z:J
    ...
    iput-wide v2, v0, Landroid/support/v7/internal/widget/AdapterViewCompat;->x:J
...
.method protected canAnimate()Z
    ...
    iget v0, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->A:I
...
.method final d()V
    ...
    .prologue
    .line 985
    iget v0, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->y:I

    iget v1, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->C:I

    if-ne v0, v1, :cond_0

    iget-wide v0, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->z:J

    iget-wide v2, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->D:J
    ...
    iget-boolean v0, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->r:Z
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->d:Landroid/support/v7/internal/widget/ac;
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/internal/widget/ac;-><init>(Landroid/support/v7/internal/widget/AdapterViewCompat;B)V

    iput-object v0, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->d:Landroid/support/v7/internal/widget/ac;
    ...
    iput v0, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->C:I

    .line 988
    iget-wide v0, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->z:J

    iput-wide v0, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->D:J
...
.method public final getOnItemClickListener()Landroid/support/v7/internal/widget/z;
    ...
    .prologue
    .line 292
    iget-object v0, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->t:Landroid/support/v7/internal/widget/z;
...
.method public final getOnItemLongClickListener()Landroid/support/v7/internal/widget/aa;
    ...
    .prologue
    .line 358
    iget-object v0, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->u:Landroid/support/v7/internal/widget/aa;
...
.method public getSelectedItemId()J
    ...
    .prologue
    .line 563
    iget-wide v0, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->x:J
...
.method public getSelectedItemPosition()I
    ...
    .prologue
    .line 554
    iget v0, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->w:I
...
.method protected onLayout(ZIIII)V
    ...
    iput v0, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->q:I
...
.method public setEmptyView(Landroid/view/View;)V
    ...
    .prologue
    .line 661
    iput-object p1, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->a:Landroid/view/View;
...
.method public setFocusable(Z)V
    ...
    .line 694
    :goto_0
    iput-boolean p1, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->b:Z

    .line 695
    if-nez p1, :cond_1

    .line 696
    iput-boolean v1, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->c:Z
...
.method public setFocusableInTouchMode(Z)V
    ...
    .line 707
    :goto_0
    iput-boolean p1, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->c:Z

    .line 708
    if-eqz p1, :cond_1

    .line 709
    iput-boolean v2, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->b:Z
...
.method setNextSelectedPositionInt(I)V
    ...
    .prologue
    .line 1106
    iput p1, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->w:I
    ...
    iput-wide v0, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->x:J

    .line 1109
    iget-boolean v0, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->o:Z
    ...
    .line 1110
    iput p1, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->l:I

    .line 1111
    iget-wide v0, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->x:J

    iput-wide v0, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->m:J
...
.method public setOnItemClickListener(Landroid/support/v7/internal/widget/z;)V
    ...
    .prologue
    .line 284
    iput-object p1, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->t:Landroid/support/v7/internal/widget/z;
...
.method public setOnItemLongClickListener(Landroid/support/v7/internal/widget/aa;)V
    ...
    .line 350
    :cond_0
    iput-object p1, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->u:Landroid/support/v7/internal/widget/aa;
...
.method public setOnItemSelectedListener(Landroid/support/v7/internal/widget/ab;)V
    ...
    .prologue
    .line 400
    iput-object p1, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->s:Landroid/support/v7/internal/widget/ab;
...
.method setSelectedPositionInt(I)V
    ...
    .prologue
    .line 1096
    iput p1, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->y:I
    ...
    iput-wide v0, p0, Landroid/support/v7/internal/widget/AdapterViewCompat;->z:J
