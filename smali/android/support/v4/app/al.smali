...
.method constructor <init>(Landroid/view/View;Landroid/transition/Transition;Landroid/view/View;Ljava/util/ArrayList;Landroid/transition/Transition;Ljava/util/ArrayList;Landroid/transition/Transition;Ljava/util/ArrayList;Ljava/util/Map;Ljava/util/ArrayList;Landroid/transition/Transition;)V
    ...
    iput-object p2, p0, Landroid/support/v4/app/al;->b:Landroid/transition/Transition;

    iput-object p3, p0, Landroid/support/v4/app/al;->c:Landroid/view/View;
    ...
    iput-object p7, p0, Landroid/support/v4/app/al;->g:Landroid/transition/Transition;

    iput-object p8, p0, Landroid/support/v4/app/al;->h:Ljava/util/ArrayList;

    iput-object p9, p0, Landroid/support/v4/app/al;->i:Ljava/util/Map;

    iput-object p10, p0, Landroid/support/v4/app/al;->j:Ljava/util/ArrayList;

    iput-object p11, p0, Landroid/support/v4/app/al;->k:Landroid/transition/Transition;
...
.method public final onPreDraw()Z
    ...
    .line 285
    iget-object v0, p0, Landroid/support/v4/app/al;->b:Landroid/transition/Transition;
    ...
    iget-object v1, p0, Landroid/support/v4/app/al;->c:Landroid/view/View;
    ...
    .line 292
    :cond_1
    iget-object v0, p0, Landroid/support/v4/app/al;->g:Landroid/transition/Transition;
    ...
    .line 295
    :cond_2
    iget-object v0, p0, Landroid/support/v4/app/al;->i:Ljava/util/Map;
    ...
    .line 302
    iget-object v4, p0, Landroid/support/v4/app/al;->k:Landroid/transition/Transition;
    ...
    .line 304
    :cond_4
    iget-object v0, p0, Landroid/support/v4/app/al;->k:Landroid/transition/Transition;
