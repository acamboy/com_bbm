...
.method public final run()V
    ...
    .line 1627
    iget-object v6, p0, Landroid/support/v4/widget/v;->a:Landroid/support/v4/widget/u;

    iget-object v0, v6, Landroid/support/v4/widget/u;->b:Landroid/support/v4/widget/bo;

    iget v2, v0, Landroid/support/v4/widget/bo;->i:I

    iget v0, v6, Landroid/support/v4/widget/u;->a:I
    ...
    iget-object v0, v6, Landroid/support/v4/widget/u;->c:Landroid/support/v4/widget/DrawerLayout;
    ...
    iget-object v3, v6, Landroid/support/v4/widget/u;->b:Landroid/support/v4/widget/bo;

    invoke-virtual {v2}, Landroid/view/View;->getTop()I

    move-result v9

    invoke-virtual {v3, v2, v1, v9}, Landroid/support/v4/widget/bo;->a(Landroid/view/View;II)Z

    iput-boolean v8, v0, Landroid/support/v4/widget/s;->c:Z

    iget-object v0, v6, Landroid/support/v4/widget/u;->c:Landroid/support/v4/widget/DrawerLayout;

    invoke-virtual {v0}, Landroid/support/v4/widget/DrawerLayout;->invalidate()V

    invoke-virtual {v6}, Landroid/support/v4/widget/u;->b()V

    iget-object v9, v6, Landroid/support/v4/widget/u;->c:Landroid/support/v4/widget/DrawerLayout;
