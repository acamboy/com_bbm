...
.method public constructor <init>(Landroid/support/v4/widget/DrawerLayout;I)V
    ...
    .prologue
    .line 1631
    iput-object p1, p0, Landroid/support/v4/widget/u;->c:Landroid/support/v4/widget/DrawerLayout;
    ...
    iput-object v0, p0, Landroid/support/v4/widget/u;->d:Ljava/lang/Runnable;
...
.method public final a()V
    ...
    .prologue
    .line 1640
    iget-object v0, p0, Landroid/support/v4/widget/u;->c:Landroid/support/v4/widget/DrawerLayout;

    iget-object v1, p0, Landroid/support/v4/widget/u;->d:Ljava/lang/Runnable;
...
.method public final a(I)V
    ...
    .line 1653
    iget-object v4, p0, Landroid/support/v4/widget/u;->c:Landroid/support/v4/widget/DrawerLayout;

    iget-object v1, p0, Landroid/support/v4/widget/u;->b:Landroid/support/v4/widget/bo;

    iget-object v5, v1, Landroid/support/v4/widget/bo;->k:Landroid/view/View;

    iget-object v1, v4, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/bo;

    iget v1, v1, Landroid/support/v4/widget/bo;->a:I

    iget-object v6, v4, Landroid/support/v4/widget/DrawerLayout;->b:Landroid/support/v4/widget/bo;

    iget v6, v6, Landroid/support/v4/widget/bo;->a:I
    ...
    iget v6, v0, Landroid/support/v4/widget/s;->b:F
    ...
    iget-object v0, v4, Landroid/support/v4/widget/DrawerLayout;->e:Landroid/support/v4/widget/r;

    if-eqz v0, :cond_1

    iget-object v0, v4, Landroid/support/v4/widget/DrawerLayout;->e:Landroid/support/v4/widget/r;

    invoke-interface {v0, v5}, Landroid/support/v4/widget/r;->b(Landroid/view/View;)V
    ...
    invoke-interface {v0, v5}, Landroid/support/v4/widget/r;->a(Landroid/view/View;)V
...
.method public final a(II)V
    ...
    iget-object v1, p0, Landroid/support/v4/widget/u;->c:Landroid/support/v4/widget/DrawerLayout;
...
.method public final b(Landroid/view/View;)V
    ...
    .line 1678
    invoke-virtual {p0}, Landroid/support/v4/widget/u;->b()V
