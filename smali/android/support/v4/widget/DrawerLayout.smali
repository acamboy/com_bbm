...
# static fields
.field static final h:Landroid/support/v4/widget/o;
...
.field final a:Landroid/support/v4/widget/bo;

.field final b:Landroid/support/v4/widget/bo;
...
.field private final p:Landroid/support/v4/widget/u;

.field private final q:Landroid/support/v4/widget/u;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/support/v4/widget/o;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/widget/n;-><init>(Landroid/support/v4/widget/DrawerLayout;)V

    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/n;
    ...
    invoke-direct {v1, p0, v2}, Landroid/support/v4/widget/u;-><init>(Landroid/support/v4/widget/DrawerLayout;I)V

    iput-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->p:Landroid/support/v4/widget/u;
    ...
    iput-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->q:Landroid/support/v4/widget/u;

    .line 342
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->p:Landroid/support/v4/widget/u;

    invoke-static {p0, v4, v1}, Landroid/support/v4/widget/bo;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/br;)Landroid/support/v4/widget/bo;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/bo;

    .line 343
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/bo;

    iput v3, v1, Landroid/support/v4/widget/bo;->j:I
    ...
    iput-object v2, v1, Landroid/support/v4/widget/u;->b:Landroid/support/v4/widget/bo;

    .line 347
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->q:Landroid/support/v4/widget/u;

    invoke-static {p0, v4, v1}, Landroid/support/v4/widget/bo;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/br;)Landroid/support/v4/widget/bo;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->b:Landroid/support/v4/widget/bo;
    ...
    .line 350
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->q:Landroid/support/v4/widget/u;

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->b:Landroid/support/v4/widget/bo;

    iput-object v1, v0, Landroid/support/v4/widget/u;->b:Landroid/support/v4/widget/bo;

    .line 353
    invoke-virtual {p0, v3}, Landroid/support/v4/widget/DrawerLayout;->setFocusableInTouchMode(Z)V

    .line 355
    invoke-static {p0, v3}, Landroid/support/v4/view/bf;->c(Landroid/view/View;I)V
    ...
    .line 359
    invoke-static {p0}, Landroid/support/v4/view/bz;->a(Landroid/view/ViewGroup;)V

    .line 360
    invoke-static {p0}, Landroid/support/v4/view/bf;->u(Landroid/view/View;)Z
    ...
    .line 361
    sget-object v0, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/support/v4/widget/o;

    invoke-interface {v0, p0}, Landroid/support/v4/widget/o;->a(Landroid/view/View;)V

    .line 362
    sget-object v0, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/support/v4/widget/o;

    invoke-interface {v0, p1}, Landroid/support/v4/widget/o;->a(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
...
.method private a(Z)V
    ...
    .line 1275
    :cond_3
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->p:Landroid/support/v4/widget/u;
...
.method static synthetic i(Landroid/view/View;)Z
    .locals 2
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-static {p1, v0}, Landroid/support/v4/view/bf;->c(Landroid/view/View;I)V
    ...
    invoke-static {p1, v0}, Landroid/support/v4/view/bf;->a(Landroid/view/View;Landroid/support/v4/view/a;)V
...
.method public computeScroll()V
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/bo;->c()Z
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    iget v2, v2, Landroid/support/v4/widget/bo;->i:I
    ...
    iget v3, v3, Landroid/support/v4/widget/bo;->i:I
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-interface {v0, v1}, Landroid/support/v4/widget/o;->a(Ljava/lang/Object;)I
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v5, v0, v3}, Landroid/support/v4/widget/bo;->b(II)Landroid/view/View;
    ...
    iget-object v0, v5, Landroid/support/v4/widget/bo;->c:[F
    ...
    iget v3, v5, Landroid/support/v4/widget/bo;->g:I
    ...
    iget-object v3, v5, Landroid/support/v4/widget/bo;->e:[F

    aget v3, v3, v0

    iget-object v7, v5, Landroid/support/v4/widget/bo;->c:[F

    aget v7, v7, v0

    sub-float/2addr v3, v7

    iget-object v7, v5, Landroid/support/v4/widget/bo;->f:[F

    aget v7, v7, v0

    iget-object v8, v5, Landroid/support/v4/widget/bo;->d:[F
    ...
    iget v7, v5, Landroid/support/v4/widget/bo;->b:I

    iget v8, v5, Landroid/support/v4/widget/bo;->b:I
...
.method protected onMeasure(II)V
    ...
    .line 855
    invoke-static {v7}, Landroid/support/v4/view/bf;->u(Landroid/view/View;)Z
    ...
    .line 856
    sget-object v9, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/support/v4/widget/o;

    iget-object v10, p0, Landroid/support/v4/widget/DrawerLayout;->B:Ljava/lang/Object;

    invoke-interface {v9, v7, v10, v8}, Landroid/support/v4/widget/o;->a(Landroid/view/View;Ljava/lang/Object;I)V
    ...
    invoke-interface {v9, v0, v10, v8}, Landroid/support/v4/widget/o;->a(Landroid/view/ViewGroup$MarginLayoutParams;Ljava/lang/Object;I)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v4, v5, v6}, Landroid/support/v4/widget/bo;->b(II)Landroid/view/View;
...
.method public setDrawerListener(Landroid/support/v4/widget/r;)V
    .locals 0

    .prologue
    .line 432
    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->e:Landroid/support/v4/widget/r;
