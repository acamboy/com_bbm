...
.method public static a(Landroid/graphics/PointF;Landroid/graphics/PointF;)F
    ...
    invoke-static {v0, v1, v2, v3}, Lcom/mapquest/android/maps/cu;->a(FFFF)F
...
.method public static a(Lcom/mapquest/android/maps/b;Lcom/mapquest/android/maps/MapView;)Landroid/graphics/Rect;
    ...
    .line 94
    instance-of v1, v0, Lcom/mapquest/android/maps/br;
    ...
    iget-object v0, v0, Lcom/mapquest/android/maps/br;->a:Lcom/mapquest/android/maps/bq;

    .line 96
    :cond_0
    iget-object v1, p0, Lcom/mapquest/android/maps/b;->a:Lcom/mapquest/android/maps/s;

    invoke-interface {v0, v1, v3}, Lcom/mapquest/android/maps/bp;->a(Lcom/mapquest/android/maps/s;Landroid/graphics/Point;)Landroid/graphics/Point;
    ...
    invoke-interface {v0, v2, v3}, Lcom/mapquest/android/maps/bp;->a(Lcom/mapquest/android/maps/s;Landroid/graphics/Point;)Landroid/graphics/Point;
...
.method public static a(Landroid/graphics/Rect;Lcom/mapquest/android/maps/MapView;)Lcom/mapquest/android/maps/b;
    ...
    invoke-interface {v1, v3, v4}, Lcom/mapquest/android/maps/bp;->a(II)Lcom/mapquest/android/maps/s;
    ...
    invoke-interface {v1, v4, v5}, Lcom/mapquest/android/maps/bp;->a(II)Lcom/mapquest/android/maps/s;
    ...
    invoke-interface {v1, v5, v6}, Lcom/mapquest/android/maps/bp;->a(II)Lcom/mapquest/android/maps/s;
...
.method public static b(Lcom/mapquest/android/maps/b;Lcom/mapquest/android/maps/MapView;)Landroid/graphics/Rect;
    ...
    invoke-interface {v1, v2, v8}, Lcom/mapquest/android/maps/bp;->a(Lcom/mapquest/android/maps/s;Landroid/graphics/Point;)Landroid/graphics/Point;
    ...
    invoke-interface {v1, v3, v8}, Lcom/mapquest/android/maps/bp;->a(Lcom/mapquest/android/maps/s;Landroid/graphics/Point;)Landroid/graphics/Point;
    ...
    invoke-interface {v1, v4, v8}, Lcom/mapquest/android/maps/bp;->a(Lcom/mapquest/android/maps/s;Landroid/graphics/Point;)Landroid/graphics/Point;
    ...
    invoke-interface {v1, v5, v8}, Lcom/mapquest/android/maps/bp;->a(Lcom/mapquest/android/maps/s;Landroid/graphics/Point;)Landroid/graphics/Point;
